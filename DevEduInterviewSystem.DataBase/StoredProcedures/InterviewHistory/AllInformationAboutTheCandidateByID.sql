...
@ID int
AS
	SELECT C.ID, C.FirstName, C.LastName, C.Email, C.Phone, C.Birthday, S.[Name] AS TypeOfStage,St.[Name] AS TypeOfStatus, Ct.[Name] AS CityName, F.[Message], F.UserID , F.TimeFeedback, F.[StageChangedID],
