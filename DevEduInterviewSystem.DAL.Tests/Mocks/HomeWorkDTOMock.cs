...
namespace DevEduInterviewSystem.DAL.Tests.Mocks
{
    public class HomeWorkDTOMock : IEnumerable
    {
        public IEnumerator GetEnumerator()
        {
            ...
            DateTime dateTest4 = new DateTime(2020, 10, 03);
            yield return new HomeworkDTO(1, 1, 1, 2, dateTest1);
            yield return new HomeworkDTO(2, 2, 1, 2, dateTest2);
            yield return new HomeworkDTO(3, 3, 1, 2, dateTest3);
            yield return new HomeworkDTO(4, 4, 1, 2, dateTest4);
        }
    }
}
